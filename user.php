...
<table align="center" cellpadding="10" cellspacing="0" width="750" bgcolor="#e4e4e4" style="border:1px solid #CCCCCC;font-size:12px">
			<tr bgcolor="#e4e4e4">
			  <td colspan="2" style="border-bottom:1px solid #CCCCCC;" bgcolor="#eeeeee" align="center"><h2>PUBLIC LOGIN</h2></td>
			  </tr>
			<tr>
			  <td align="right">&nbsp;</td>
			  <td>&nbsp;</td>
	...
	<tr>
			...
			<tr>
			  ...
			  <a href="reg.php"><strong>New User Register Here</strong></a>
			  </td>
			  </tr>
			</table>
	</form>
...
$sqlup="Select * from public
	where pub_user='".$user_name."' AND pub_pwd='".$user_pwd."'";

	$we=mysqli_query($con,$sqlup);
	$res=mysqli_fetch_object($we);
if($res->pub_user==$user_name && $res->pub_pwd ==$user_pwd)
{
	
$_SESSION['public_id']=$res->pub_id;
$_SESSION['public_name']=$res->pub_name;
$_SESSION['user_name']=$res->pub_user;
$_SESSION['user_pwd']=$res->pub_pwd;
