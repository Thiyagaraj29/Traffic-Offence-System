...
$sel="select * from fir where ".$where." order by fir_id desc"; 
 ...
 ?>
  <tr>
    <td align="center"><?php echo $sta->fir_no; ?></td>
	<td align="center"><?php echo $sta->fir_date; ?></td>
	<td align="center"><?php echo $sta->fir_sta; ?></td>
    <td align="center"><?php echo $sta->fir_informant; ?></td>
    <td align="center"><?php echo $sta->fir_status; ?></td>
    <td align="center">
	
	<a href="view.php?id=<?php echo $sta->fir_id; ?>" style="text-decoration:none">
		VIEW</a></td>
	</tr>
  <?php } ?>
  </table></td></tr>
